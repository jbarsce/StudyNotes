...
\begin{itemize}
  \item IMPALA actors communicate trajectories of experience (sequences of states, actions, and rewards) to a centralised learner, instead of gradients such as in A3C.
  \item V-trace off-policy actor-critic algorithm to avoid policy-lag between actors and the central learner(s).
\end{itemize}
